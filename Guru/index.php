  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="?page=frame&aksi=tambahfoto">
            <i class="fa fa-check-square-o"></i> <span>Frame</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
      ...
      <div class="row">
        ...
        <?php
          ...
          if($page=='gkandidat'){
            ...
            if ($aksi=='tambahfoto') {
              include 'frame/tambah_foto.php';
            } else if ($aksi=='upload') {
              include 'frame/proses/upload_foto.php';
            } else if ($aksi=='hasilfoto') {
              include 'frame/hasil_foto.php';
            } else if ($aksi=='simpanfoto') {
              include 'frame/proses/simpan_foto.php';
            } else if ($aksi=='tampilframe') {
              include 'frame/hasil_frame.php';
            }
          }
        ?>
      </div>
