    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../Assets/dist/img/<?php echo $data['foto'];?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?page=sekolah&aksi=aktif"><i class="fa fa-institution"></i> Data Sekolah</a></li>
            <li><a href="?page=admin&aksi=aktif"><i class="fa fa-child"></i> Data Admin</a></li>
          </ul>
        </li>
      </ul>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <?php
          ...
          if($page=='sekolah'){
            if($aksi=='aktif'){
              include 'kelola_sekolah/tampil_sekolah.php';
            }else if($aksi=='tambah'){
              include 'kelola_sekolah/tambah_sekolah.php';
            }else if($aksi=='edit') {
              include 'kelola_sekolah/edit_sekolah.php';
            }else if($aksi=='delete') {
              include 'kelola_sekolah/proses/delete_sekolah.php';
            }else if($aksi=='insert'){
              include 'kelola_sekolah/proses/insert_sekolah.php';
            }else if($aksi=='update'){
              include 'kelola_sekolah/proses/update_sekolah.php';
            }
          } else if($page=='admin'){
            if($aksi=='aktif'){
              include 'kelola_admin/tampil_admin.php';
            }else if($aksi=='tambah'){
              include 'kelola_admin/tambah_admin.php';
            }else if($aksi=='edit') {
              include 'kelola_admin/edit_admin.php';
            }else if($aksi=='delete') {
              include 'kelola_admin/proses/delete_admin.php';
            }else if($aksi=='insert'){
              include 'kelola_admin/proses/insert_admin.php';
            }else if($aksi=='update'){
              include 'kelola_admin/proses/update_admin.php';
            }
