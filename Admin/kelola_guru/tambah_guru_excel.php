...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Import Data Guru</strong> <a class="btn btn-success" href="../assets/excel/format_guru.xlsx">Download Format Excel</a></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=guru&aksi=insert_excel" method="POST" enctype="multipart/form-data">
