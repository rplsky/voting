									...
									backgroundColor: [
															...
															<?php	
																...
																while ($warna = $sql_warna->fetch()) {
																	$query_kelas3 = "SELECT DISTINCT kelas FROM tbl_siswa Where id_sekolah LIKE '$id_skl' ORDER BY kelas";
																	$sql_kelas3 = $pdo->prepare($query_kelas3);
																	$sql_kelas3->execute();

																	while ($kelas3 = $sql_kelas3->fetch()) {
																		echo "' ". $warna['warna'] . " ',";
																	}
																}
															?>
