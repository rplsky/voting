<?php
	...
	$query = "SELECT * FROM tbl_siswa Where id_sekolah LIKE '$id_skl' AND status LIKE 'T' ORDER BY kelas LIMIT $limit_start,$limit";
...
<div class="panel panel-default">
	<div class="panel-heading">
				<h3><strong>Data Belum Memilih</strong></h3>
			</div>
		...
		<ul class="pagination">
				...
				?>
					<li><a href="?page=pemilih&aksi=pemilihbelum&hal=1">First</a></li>
					<li><a href="?page=pemilih&aksi=pemilihbelum&hal=<?php echo $link_prev; ?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_siswa Where id_sekolah LIKE '$id_skl' AND status LIKE 'T' ORDER BY kelas");
				...
				?>
					<li<?php echo $link_active; ?>><a href="?page=pemilih&aksi=pemilihbelum&hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li><a href="?page=pemilih&aksi=pemilihbelum&hal=<?php echo $link_next; ?>">&raquo;</a></li>
					<li><a href="?page=pemilih&aksi=pemilihbelum&hal=<?php echo $jumlah_hal; ?>">Last</a></li>
				<?php
				}
				?>
			</ul>
